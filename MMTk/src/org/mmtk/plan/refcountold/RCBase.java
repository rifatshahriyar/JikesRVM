 ...
 */
package org.mmtk.plan.refcountold;
...
import org.mmtk.plan.refcountold.backuptrace.BTFreeLargeObjectSweeper;
import org.mmtk.plan.refcountold.backuptrace.BTScanLargeObjectSweeper;
import org.mmtk.plan.refcountold.backuptrace.BTSweeper;
...
public class RCBase extends StopTheWorld {
   ...
   */
  protected static final short refcountoldCollectionPhase = Phase.createComplex("release", null,
  ...
  //public static final org.mmtk.utility.statistics.AtomicEventCounter incCount = new org.mmtk.utility.statistics.AtomicEventCounter("incCount");
  //public static final org.mmtk.utility.statistics.AtomicEventCounter decCount = new org.mmtk.utility.statistics.AtomicEventCounter("decCount");
  ...
  public void processOptions() {
    ...
    org.mmtk.utility.Log.writeln(RCHeader.INCREMENT);
    org.mmtk.utility.Log.writeln(RCHeader.BITS_USED);
    org.mmtk.utility.Log.writeln(RCHeader.RC_HEADER_OFFSET);
    org.mmtk.utility.Log.writeln(BITS_IN_ADDRESS);
    org.mmtk.utility.Log.writeln(BYTES_IN_ADDRESS);
